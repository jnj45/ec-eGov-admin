...
import static net.ecbank.fwk.admin.log.entity.QLoginLog.loginLog;
...
import net.ecbank.fwk.admin.log.dto.QLoginLogDto;
import net.ecbank.fwk.admin.log.entity.QLoginLog;
