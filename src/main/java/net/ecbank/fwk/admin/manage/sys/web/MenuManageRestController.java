...
import net.ecbank.fwk.admin.manage.sys.dto.ProgramDto;
import net.ecbank.fwk.admin.manage.sys.entity.Menu;
import net.ecbank.fwk.admin.manage.sys.service.MenuManageService;
...
public class MenuManageRestController {
	...
	@PostMapping("/saveMenuAuthRel")
	public MenuDto saveMenuAuthRel(@RequestBody MenuDto menuDto) {
		
		Response res = new Response();
		
		try {
			
			menuManageService.saveMenuAuthRelation(menuDto);
